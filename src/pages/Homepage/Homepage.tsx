  ...
  return (
    <div className="homepage">
      ...
      <div className="homepage__seoBlock">
        ...
        {`Орендуйте PlayStation для невеликих вечірок, дня народження або просто пограти у FC(FIFA). У нас ви знайдете широкий вибір ігор, обладнання в чудовому стані та рекомендації щодо ігор від наших менеджерів.
