  ...
  return (
    <div className="agreement">
      ...
      <div className='agreement__statement' id="Вік орендаря">
        ...
        <p className="agreement__paragraph">Орендувати PlayStation можуть тільки ті особи, які досягли 18-річного віку. Однак, якщо вам ще не виповнилося 18 років, ви можете попросити своїх батьків взяти консоль напрокат за вас.</p>
