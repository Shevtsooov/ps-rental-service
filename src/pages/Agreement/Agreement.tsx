  ...
  return (
    <div className="agreement">
      ...
      <div className='agreement__statement' id="Тривалість Оренди">
        ...
        <p className="agreement__paragraph">Ми розуміємо, що точний час отримання може бути важливим для вас, і робимо все можливе, щоб забезпечити якнайшвидше видання обладнання. Прохання pрозуміти цю особливість і уточнювати час отримання в менеджерів перед замовленням, або ж запитувати в коментарі до замовлення.</p>
